...
/**
 * Mutation to incremenet a track's number of views
 */
...
const TrackCard: React.FC<{ track: Omit<Track, "modules"> }> = ({ track }) => {
  ...
  // BU dizi iki eleman alır. Birincisi mutate fonksiyonu, ikincisi ise mutation ile alakalı bilgiler içeren bir obje, loading, error ve data.
  // Bu component de ihtiyacımız olmadığı için extract etmedik.
